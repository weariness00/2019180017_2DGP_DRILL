...
class WalkingState:
    ...
    def draw(boy):
        ...
        boy.font.draw(sx, sy + 50, boy.earnCount.__str__(), (255, 255, 0))
...
class Boy:
    ...
    def get_bb(self):
        return self.x - 20 - server.background.window_left, self.y - 40 - server.background.window_bottom, self.x + 20 - server.background.window_left, self.y + 40 - server.background.window_bottom
